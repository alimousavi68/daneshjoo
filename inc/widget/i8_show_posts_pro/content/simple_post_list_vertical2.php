...
if ($hide_title != 'on') { ?>
    <div
        ...
        <p class=" f14 fw-4 text-grey mb-3  d-none d-xl-block d-lg-block d-md-block" style="color:'. $cat_color. '">
            <?php echo $sub_title_print; ?>
        </p>
        <p class="display-5 fw-4 mb-2 ">
            <a class="cat_btn_link " href="<?php echo get_category_link($cat); ?>">دیدن همه</a>
        </p>
    </div>
