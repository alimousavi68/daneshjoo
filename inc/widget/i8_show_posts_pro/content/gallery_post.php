...
echo '<div class="text-title box-title  ' . $head_font_size . ' fw-7 m-0 me-lg-2 me-md-2 mb-3"  style="color:'. $cat_color. '">';
if ($hide_title != 'on') {
...
?>
        <div class="col-xl-12 col-lg-24 col-md-24 col-sm-12 px-xl-1 px-lg-1 px-md-1 px-3 px-md-3" >
            <div class="post-flip-box-container image_frame <?php echo $thumb_radius; ?>" >
                <?php echo i8_the_thumbnail('i8-621-389', 'post-flip-box-image object-fit-cover ' . $thumb_radius , array("width" => 590, "height" => 370)); ?>
                ...
                <div class="post-flip-box-overlay d-flex align-items-end">
                    <h2 class="post-flip-box-title0">
                        <a class="display-3 post-flip-box-link l1 fw-7 fd-7  text-white " href="<?php echo get_the_permalink(); ?>"><?php i8_limit_text(get_the_title(), 100, '...'); ?></a>
                    </h2>
                </div>
            </div>
        </div>
...
if ($category_posts2->have_posts()) {
    echo '<div class="col-xl-12 col-md-24 col-sm-24 col-24 row row-gap-4">';
    ...
    ?>
        <div class="col-24 col-lg-12 col-md-12 col-sm-24 col-xl-12 px-1">
            <div class="post-flip-box-container <?php echo $thumb_radius; ?> " class="image_frame">
                <?php echo i8_the_thumbnail('i8-294-184', 'post-flip-box-image object-fit-cover ' . $thumb_radius, array("width" => 279, "height" => 172)); ?>
                ...
                <div class="post-flip-box-overlay d-flex align-items-end">
                    <h2 class="post-flip-box-title0">
                        <a class="<?php echo $title_font_size; ?> post-flip-box-link l1  fw-4 fd-7 text-white" href="<?php echo get_the_permalink(); ?>"><?php i8_limit_text(get_the_title(), 110, '...'); ?></a>
                    </h2>
                </div>
            </div>
        </div>
