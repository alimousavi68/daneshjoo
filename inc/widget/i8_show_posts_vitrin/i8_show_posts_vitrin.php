<?php
class i8_show_posts_vitrin extends WP_Widget
{
    ...
    {
        $opt_array = array(
            'class' => 'i8_show_posts_vitrin',
            'description' => 'نمایش پست های یک دسته بندی به صورت اسلایدر بزرگ سه بخشی'
        );
        parent::__construct('i8-show-posts-vitrin', 'i8: نمایش پست های ویترین ', $opt_array);
    }
...
function i8_show_posts_vitrin_func()
{
    register_widget('i8_show_posts_vitrin');
}
add_action('widgets_init', 'i8_show_posts_vitrin_func');
