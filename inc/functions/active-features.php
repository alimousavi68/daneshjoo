 ...
 */
add_image_size('i8-621-389', 621 , 389 , true);
add_image_size('i8-420-256', 420 , 256 , true);
add_image_size('i8-294-184', 294 , 184 , true);
add_image_size('i8-129-100', 129 , 100 , true);
add_image_size('i8-80-63'  , 80  , 63  , true);
