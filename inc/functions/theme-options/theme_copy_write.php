...
function i8_customize_register_copy_write($wp_customize)
{
     ...
     * Add Setting
     */
    $wp_customize->add_setting('i8_light_primary_color',  array('default' => '#41CADD', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_dark_primary_color', array('default' => '#191b27', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_light_secondary_color', array('default' => '#8c8c8c', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_dark_secondary_color', array('default' => '#f8f8f8', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_light_complete_color',  array('default' => '#ff7a00', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_dark_complete_color', array('default' => '#ff7a00', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_light_bg_color', array('default' => '#f8f8f8', 'transport' => 'refresh'));
    $wp_customize->add_setting('i8_dark_bg_color', array('default' => '#191b27', 'transport' => 'refresh'));
