...
function i8_add_custom_sidebar()
{
    ...
    register_sidebar(
        array(
            ...
            'before_widget' => '<div class="widget  box-style-white p-2 p-xl-4 p-lg-4 p-sm-4 box">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
            'before_sidebar' => '',
    ...
    register_sidebar(
     ...
     register_sidebar(
        array(
            'name' => 'ستون  زیر اسلایدر',
            'id' => 'h-sub-slider',
            'class' => 'h-sub-slider',
            'description' => 'این ستون در صفحه اصلی زیر اسلایدر قرار میگیرد',
            'before_widget' => '<div class="widget ">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
    ...
    register_sidebar(
        array(
            ...
            'before_widget' => '<div class="widget box-style-white p-2 p-xl-4 p-lg-4 p-sm-4">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
            'before_sidebar' => '',
    ...
    //  home main bar - center - سایدبار اصلی صفحه نخست
    register_sidebar(
        array(
            'name' => 'ستون اصلی - صفحه نخست زیر ویژه سمت وسط',
            'id' => 'hmec-sidebar',
            'class' => 'hmec-sidebar',
            'description' => 'این ستون در صفحه اصلی و در سمت وسط زیر ویژه قرار میگیرد.',
            'before_widget' => '<div class="row widget box p-2 ">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
    ...
    register_sidebar(
        array(
            ...
            'before_widget' => '<div class="widget box-style-white p-2 p-xl-4 p-lg-4 p-sm-4  p-2 p-sm-2 box">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
            'before_sidebar' => '',
    ...
    register_sidebar(
        array(
            ...
            'before_widget' => '<div class="widget   box p-2 p-sm-2 box-style-white p-2 p-xl-4 p-lg-4 p-sm-4 box">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
            'before_sidebar' => '',
    ...
    register_sidebar(
        array(
            ...
            'before_widget' => '<div class="widget  box-style-white p-2 p-xl-4 p-lg-4 p-sm-4 box mb-0">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
            'before_sidebar' => '',
    ...
    register_sidebar(
        array(
            ...
            'before_widget' => '<div class="widget  d-flex flex-column align-items-center align-content-center ">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
            'before_sidebar' => '',
