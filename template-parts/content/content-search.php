<?php ?>
<div class="row mx-0 ">
    <div class="col-xl-17 col-md-24 col-sm-24 d-flex flex-column box px-3 row-gap-3">

        <div class=" row d-flex py-3 mx-0 align-content-center row-gap-1 box-style-white p-2 p-xl-4 p-lg-4 p-sm-4">
            ...
            <form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
                <div class="i8-wrapper">
                    <div class="i8-container">
                        <input type="search" class="i8-input w-100 rounded-4" placeholder="عبارت مورد نظر …"
                            value="<?php echo get_search_query(); ?>" name="s" />
                        <button type="submit" class="i8-close-btn rounded-4">
                            <?php echo $icon_print; ?>
                        </button>
                    </div>
                </div>
    ...
    <!-- sidebar  -->
    <div
        class="al-sidebar col-xl-7 col-md-24 col-sm-24 ps-0 pt-4 pt-xl-0 pt-md-4 pt-sm-4 pe-xl-3 pe-0 pe-sm-0 i8-sticky">
