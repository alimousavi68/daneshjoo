        ...
        <div
            ...
            <div class="col-xl-11 col-lg-11 col-md-11 col-sm-11 col-24 px-0 px-sm-2 ps-lg-0">
                <span class="image_frame">
                    <?php echo i8_the_thumbnail('i8-420-256', 'hover w-100 rounded-3  object-fit-cover i8-h-md-100', $size = array('width' => 410, 'height' => 242), true, 'min-height:275px;', false, true); ?>
                </span>
            </div>
        </div>
    </div>
