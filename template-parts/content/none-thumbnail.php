...
<div class="col-md-24 col-sm-24 col-xl-18 d-flex flex-column gap-2 pe-0 ps-0 ps-xl-3 ps-lg-3 ps-md-2 ps-sm-0 ">
    ...
    <!-- breadcrumb -->
    <div
        class=" d-flex align-items-top pb-2 mx-0 align-content-center row-gap-3 i8-breadcrumb box p-2 order-2 order-xl-1 order-lg-1  align-items-center  flex-wrap justify-content-around box-style-white p-2">
    ...
    <!-- intro -->
    <div
        class="article d-flex flex-column gap-3 justify-content-between box p-xl-4 p-lg-4 p-md-4 p-0 order-1 order-xl-2 order-lg-2 box-style-white p-2 p-xl-4 p-lg-4 p-sm-4">
        ...
        <div class="row">
            ...
            <div class="col-24 col-xl-18 col-sm-18 text-justify align-items-top">
            ...
            <div class="col-xl-6 col-sm-6 col-24 align-items-top mb-3">
                <?php
                ...
                if ($author_name): ?>
                    <div class="reference d-flex flex-wrap align-items-center row">
                        <div class="col-auto px-0">
                            <?php echo i8_the_thumbnail('i8-80-63', 'author_img_style', $size = array('width' => 50, 'height' => 50), true, '', false, true); ?>
                        </div>
                        <div class="col">
