...
<div class="col-md-24 col-sm-24 col-xl-18 d-flex flex-column gap-2 pe-0 ps-0 ps-xl-3 ps-lg-3 ps-md-2 ps-sm-0">
    <!-- breadcrumb -->
    <div
        class=" d-flex align-items-top pb-2 mx-0 align-content-center row-gap-3 i8-breadcrumb box p-2 flex-wrap justify-content-around box-style-white p-2">
    ...
    <!-- body -->
    <section class="d-flex flex-column row-gap-3 box p-4 mt-2 box-style-white p-2 p-xl-4 p-lg-4 p-sm-4">
