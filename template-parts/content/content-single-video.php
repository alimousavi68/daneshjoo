...
<div class="col-md-24 col-sm-24 col-xl-18 d-flex flex-column gap-2 pe-0 ps-0 ps-xl-3 ps-lg-3 ps-md-2 ps-sm-0">
    ...
    if (is_active_sidebar('st-sidebar')) {
        echo '<div class="st-sidebar row d-flex mx-0 align-content-center row-gap-3">';
        dynamic_sidebar('st-sidebar');
        echo '</div>';
    }
    ?>
    <!-- breadcrumb -->
    <div class=" d-flex align-items-top pb-2 mx-0 align-content-center row-gap-3 i8-breadcrumb box p-2 order-2 order-xl-1 order-lg-1  align-items-center  flex-wrap justify-content-around box-style-white p-2">
    ...
    <!-- intro -->
    <div class="article d-flex flex-column gap-3 justify-content-between box p-xl-4 p-lg-4 p-md-4 p-0 order-1 order-xl-2 order-lg-2 box-style-white p-2 p-xl-4 p-lg-4 p-sm-4 ">
                        ...
                        <div class="download-content">
                            <ul class="i8-downloadbox">
                                <?php if ($video_url_high): ?>
                                    <li><a class="" href="<?php echo $video_url_high; ?>" target="_blank" download>دانلود سایز بزرگ</a></li>
                                    <?php
                                endif;
                                if ($video_url): ?>
                                    <li><a class="" href="<?php echo $video_url; ?>" target="_blank" download>دانلود سایز متوسط</a></li>
                                    <?php
                                endif;
                                if ($video_url_low): ?>
                                    <li><a class="" href="<?php echo $video_url_low; ?>" target="_blank" download>دانلود سایز کم</a></li>
                                <?php endif; ?>
    ...
    <!-- body -->
    <section class="d-flex flex-column row-gap-3 box p-4 mt-2  order-3 order-xl-3 order-lg-3 box-style-white p-2 p-xl-4 p-lg-4 p-sm-4">
        ...
        if (is_active_sidebar('sf-sidebar')) {
            echo '<div class="sf-sidebar row d-flex py-3 mx-0 align-content-center row-gap-3">';
