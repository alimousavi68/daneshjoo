...
// breaking news ticker js
// ---------------------------------------------------------

!function (t, e) {
  "use strict";

  "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && "object" == _typeof(module.exports) && (module.exports = t.document ? void 0 : function (t) {
  ...
  t.breakingNews = function (e, i) {
    ...
    n.init = function () {
      ...
      }), r.addClass("bn-effect-" + n.settings.effect + " bn-direction-" + n.settings.direction), w(), "object" == _typeof(n.settings.source)) switch (n.settings.source.type) {
        case "rss":
          "rss2json" === n.settings.source.usingApi ? ((d = new XMLHttpRequest()).onreadystatechange = function () {
            if (4 == d.readyState && 200 == d.status) {
              ...
              var s = "";
              void 0 !== n.settings.source.seperator && void 0 !== _typeof(n.settings.source.seperator) && (s = n.settings.source.seperator);
        ...
        case "json":
          t.getJSON(n.settings.source.url, function (t) {
            ...
            for (var r = 0; r < t.length && !(r >= n.settings.source.limit); r++) {
              n.settings.source.linkEnabled ? i += '<li><a target="' + n.settings.source.target + '" href="' + t[r].link + '">' + s + t[r][e] + "</a></li>" : i += "<li><a>" + s + t[r][e] + "</a></li>", "undefined" === t[r][e] && console.log('"' + e + '" does not exist in this json.');
            }
